...
public class EstateSector extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estate_sector);
        ...
        //getting components
        tgrowercode = findViewById(R.id.estate_growercode);
        tcoffeearea = findViewById(R.id.estate_area);
        tvarietymature1 = findViewById(R.id.estate_mature_1);
        tvarietymature2 = findViewById(R.id.estate_mature_2);
        tvarietymature3 = findViewById(R.id.estate_mature_3);
        tvarietymature4 = findViewById(R.id.estate_mature_4);
        tvarietymature5 = findViewById(R.id.estate_mature_5);
        tvarietyyoung1 = findViewById(R.id.estate_young_1);
        tvarietyyoung2 = findViewById(R.id.estate_young_2);
        tvarietyyoung3 = findViewById(R.id.estate_young_3);
        tvarietyyoung4 = findViewById(R.id.estate_young_4);
        tvarietyyoung5 = findViewById(R.id.estate_young_5);
        tquantitycherry = findViewById(R.id.estate_cherry_quantity);
        tquantitymbuni = findViewById(R.id.estate_mbuni_quantity);
        tratescherry = findViewById(R.id.estate_cherry_rates);
        tratesmbuni = findViewById(R.id.estate_mbuni_rates);
        tpachment1 = findViewById(R.id.estate_patchment_p1);
        tpachment2 = findViewById(R.id.estate_patchment_p2);
        tpachment3 = findViewById(R.id.estate_patchment_p3);
        tpachment4 = findViewById(R.id.estate_patchment_p4);
        tpachmentL = findViewById(R.id.estate_patchment_pl);
        ttotalcoffee = findViewById(R.id.estate_clean_coffee);
        //another window
        tfungicide = findViewById(R.id.estate_Fungicide);
        tinsecticide = findViewById(R.id.estate_Insecticide);
        therbicide = findViewById(R.id.estate_Herbicide);
        tfertilizer1 = findViewById(R.id.estate_Fertilizer_1);
        tfertilizer2 = findViewById(R.id.estate_Fertilizer_2);
        tfertilizer3 = findViewById(R.id.estate_Fertilizer_3);
        tfertilizer4 = findViewById(R.id.estate_Fertilizer_4);
        tnursery_A_quantity = findViewById(R.id.estate_variety_sold_1);
        tnursery_A_planted = findViewById(R.id.estate_variety_planted_1);
        tnursery_B_quantity = findViewById(R.id.estate_variety_sold_2);
        tnursery_B_planted = findViewById(R.id.estate_variety_planted_2);
        ...
        buttonprevious = findViewById(R.id.estate_previous);
        buttonsubmit = findViewById(R.id.estate_submit);
        bverify = findViewById(R.id.btn_etsate_verify);
        spinner = findViewById(R.id.progressBarEstate);
        ...
        buttonbgnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast toast = Toast.makeText(EstateSector.this, "Production Data Section", Toast.LENGTH_LONG);
        ...
        buttonpdnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (verified == 0) {
                    Toast toast = Toast.makeText(EstateSector.this, "Farm Input Section", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                    spinner.setVisibility(View.VISIBLE);
                    viewFlipper.showNext();
    ...
    //process data
    public void estateDataProcessing(View view) {
        EditText[]  testEmpty = {
                tfungicide = findViewById(R.id.estate_Fungicide),
                tinsecticide = findViewById(R.id.estate_Insecticide),
                therbicide = findViewById(R.id.estate_Herbicide),
    ...
    public void checkConnection(Context context) {
        ...
        if (activeNetworkInfo != null) { // connected to the internet
            ...
            if (activeNetworkInfo.getType() == ConnectivityManager.TYPE_WIFI || activeNetworkInfo.getType() == ConnectivityManager.TYPE_MOBILE) {
                ...
                String[] sendData = {growercode, coffeearea, varietymature1, varietyyoung1, varietymature2, varietyyoung2, varietymature3, varietyyoung3, varietymature4, varietyyoung4, varietymature5, varietyyoung5, quantitycherry, quantitymbuni, ratescherry, ratesmbuni, pachment1, pachment2, pachment3, pachment4, pachmentl, totalcoffee, fungicide, insecticide, herbicide, fertilizer1, fertilizer2, fertilizer3, fertilizer4, nursery_A_quantity, nursery_A_planted, nursery_B_quantity, nursery_B_planted, userID};
                //submit data
                Estate_Processing estate = new Estate_Processing(this);
                estate.execute(sendData);
            }
        } else {
            niftyDialogBuilder
