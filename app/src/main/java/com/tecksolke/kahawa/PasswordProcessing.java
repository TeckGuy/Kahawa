...
/**
 * Created by techguy on 2/24/18.
 */

public class PasswordProcessing extends AsyncTask<String, Void, String> {
    HttpURLConnection httpURLConnection;
    Context context;

    //context constructor
    PasswordProcessing(Context ctx) {
        context = ctx;
    }
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        ChangePassword.bchangepassword.setText("PROCESSING...");
        ChangePassword.bchangepassword.setEnabled(false);
        ChangePassword.spinner.setVisibility(View.VISIBLE);
    }
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            ChangePassword.bchangepassword.setText("CHANGE PASSWORD");
            ChangePassword.bchangepassword.setEnabled(true);
            ChangePassword.spinner.setVisibility(View.GONE);
            ChangePassword.Username.setText("");
            ChangePassword.Password.setText("");
            ChangePassword.confirmPasword.setText("");
            //dialog
