...
/**
 * Created by techguy on 2/13/18.
 */

public class Coop_Processing extends AsyncTask<String, Void, String> {
    ...
    private void notifyUser() {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(context)
                        ...
                        .setContentTitle("Cooperative Data Submission!")
                        .setAutoCancel(true)
                        .setWhen(0)
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        CoopSector.buttonsubmit.setText("PROCESSING...");
        CoopSector.buttonsubmit.setEnabled(false);
        CoopSector.buttonprevious.setEnabled(false);
        CoopSector.spinner.setVisibility(View.VISIBLE);
    }

    @Override
    protected void onPostExecute(String s) {
        super.onPostExecute(s);
        CoopSector.buttonsubmit.setText("SUBMIT");
        CoopSector.buttonsubmit.setEnabled(true);
        CoopSector.buttonprevious.setEnabled(true);
        CoopSector.spinner.setVisibility(View.GONE);
        //dialog notification
        final NiftyDialogBuilder niftyDialogBuilder = NiftyDialogBuilder.getInstance(context);
        niftyDialogBuilder
                .withTitle("Co-operate Response")
